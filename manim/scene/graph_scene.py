...
from .. import config
from ..animation.creation import DrawBorderThenFill, ShowCreation, Write
...
class GraphScene(Scene):
    CONFIG = {
        ...
        "x_label_position":
        UP + RIGHT,  # where to place the label of the x axis
        "y_label_position":
        UP + RIGHT,  # where to place the label of the y axis
        "x_axis_config": {},
        "y_axis_config": {},
    }
    ...
    def setup_axes(self, animate=False):
        ...
        if self.x_axis_label:
            ...
            x_label.next_to(
                x_axis.get_tips()
                if self.include_tip else x_axis.get_tick_marks(),
            ...
            points = VGroup(*list(
                map(
                    ...
                    [
                        ...
                        self.coords_to_point(x +
                                             width_scale_factor * dx, y_point),
                        graph_point,
                    ],
                )))
